...
<body>
            ...
            <div id="carouselExampleFade" class="carousel slide carousel-fade position-relative" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active data-interval=" 10000"">
                        <img src="../img/Attic01.jpg" class="d-block w-100" alt="...">
                    </div>
                    <div class="carousel-item data-interval=" 10000"">
                        <img src="../img/Attic02.jpg" class="d-block w-100" alt="...">
                    </div>
                    <div class="carousel-item data-interval=" 10000"">
                        <img src="../img/Attic03.jpg" class="d-block w-100" alt="...">
                    </div>
                </div>
        ...
        <div class="container-fluid">
            <div class="news">
                ...
                <div class="news-content d-flex">
                    <div class="news-content-one col-sm-4 col-xl-4">
    ...
    <section class="line01">
        <div class="container-fluid">
            ...
            <div class="water-fall ">
                <h3>店家空間介紹</h3>
                <div class="water-fall-col col position-relative">
                    <div class="col-item  col-item--height2 position-absolute">

                        <img src="../img/Attic-space-01.jpg" alt="">
                    ...
                    <div class="col-item col-item--height3 position-absolute">
                        ...
                        <h3>STORE STYLE</h3>
                        <h4>店家風格</h4>
                        <p>調酒的世界帝國！南美香料與在地食材結合，品味台北曼哈頓的時尚微醺。抵達傳說中的加勒比海海岸之前，你必須輸入一組四位數的密碼，打開任意門後，從幽暗的通道拾階而上，歡迎光臨，這裡是閣樓貿易公司。穿過一樓的「榕
                            RON Xinyi」，在工作人員指引下，映入眼簾的是佈滿著大大小小密碼鎖的大門，拉開門進入Attic Trade Company。
                        </p>

                    </div>
                    <div class="col-item col-item--weight1 position-absolute">

                        <img src="../img/Attic-space-04.jpg" alt="">

                    </div>
                    <div class="col-item col-item--weight2 position-absolute">

                        <img src="../img/Attic-space-02.jpg" alt="">

                    </div>
                    <div class="col-item col-item--weight3 position-absolute">

                        <img src="../img/Attic-space-03.jpg" alt="">
                    ...
                    <div class="col-item col-item--height4 position-absolute">
                        ...
                        <h3>INTRODUCTION</h3>
                        <h4>店家介紹</h4>
                        <p>酒單以七原罪、七美德命名。很明顯地創造出優雅與深度，除了殖民時級的裝潢，酒單更是以七原罪、七美德命名，訴求原創與嶄新的創意酒品，並在四樓的室內空間可搭配嚴選的雪茄，也戶外宛如台北曼哈頓的天台小空間可供紙菸換氣。來到這裡，你可以見到哈瓦那的街景，加勒比海的浪花，以及卡斯楚時代街上寫著「我們相信夢想」的虛實交錯之夜。
                        </p>
                ...
                <div class="wrapper">
                    ...
                    <div class="cols">
                        <div class="col" ontouchstart="this.classList.toggle('hover');">
                            <div class="container">
                                <div class="front" style="background-image: url(../img/Attic-drink01.jpg)">
                                    <div class="inner">
                                ...
                                <div class="back">
                                    <div class="inner">
                                        <p><span>一杯經典Tiki調酒，讓想像回到大航海的時代。</span>
                                            取蒔蘿浸過威士忌平衡味道，再用芒果泥和椰奶去帶出仕高利達金牌威士忌的香甜，一杯入喉，最能感受如簽完合約的殖民者，徜徉在加勒比海沙灘上看著夕陽吹風的自在暢快，讓日常的壓力全隨著酒精消散。這款趣味十足的作品，以60ml威士忌為基底，加入30ml芒果果泥、15ml椰奶、20ml龍舌蘭糖漿、萊姆汁7.5ml等融合成一款魔幻熱帶的Tiki調酒。風格甜美的威士忌，與清甜芒果的搭配，毫無違和感。
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col" ontouchstart="this.classList.toggle('hover');">
                            <div class="container">
                                <div class="front" style="background-image: url(../img/Attic-drink02.jpg)">
                                    <div class="inner">

                                        <h2>Flying Gaucho, Yee-Haw !</h2>
                                    </div>
                                </div>
                                <div class="back">
                                    <div class="inner">
                                        <p> <span>急著長大偷喝啤酒的小屁孩，長大後才發現了啤酒苦澀是為了逃避。</span>以綠色草本為軸線，採集草本和茶的香氣，用來堆疊皮斯可和苦艾酒的厚重，最後一滴的柳橙苦精，是畫龍點睛的妙提味，一口口說著，來自南方的印地安和西班牙混血牛仔，喝著海尼根的自由奔放氣息。此款創意調酒，以50ml海尼根作為基底，再加入20ml的瑪黛茶浸製加勒維多皮斯可、20ml不甜苦艾酒、5ml蝴蝶百合糖漿、15ml柳橙苦精、30ml綠茶等調製成的一款帶有拉丁風味的調酒。口感順口，嚐不出酒精的過份干擾。
                                        </p>
                                    </div>
                                </div>
                            </div>
    ...
    <section class="line03">
        <div class="intro container-fluid">
            ...
            <div class="food-intro d-flex ">
                ...
                <div class="food-item food-intro-pic02 col-12 col-md-3 px-0 m-0">
                ...
                <div class="food-item food-intro-pic03 col-12 col-md-6 px-0 m-0">
    ...
    <section class="line04">
        <div class="intro container-fluid">
            <h3>會員熱烈評價</h3>
            <div class="row align-items-start">
                <div class="comment col position-relative d-flex">
                    <div class="comment-pic"><img src="../img/customer01.jpg" alt=""></div>
                    <div class="comment-name position-absolute">
                        <h6>陳志龍</h6>
                    </div>
                    <div class="comment-time position-absolute">
                        <h6>2個月前</h6>
                    </div>
                    ...
                    <div class="comment-content position-absolute">
                        <p>解密-開門-上樓-選位-入座，
                            一切都在體驗之中，不論單人 情侶 三五好友
                            都可以選到適合的位子，個人最愛一進門左手邊的獨立包廂位子，令人振奮的懷舊風裝潢細節配上奢華水晶吊燈，只能說老板的巧思不簡單，服務生的桌邊服務和顏值很誇張，你一定會心情絕佳，為這份今晚的體驗有了最美的畫龍點睛。
                        </p>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                <div class="comment col position-relative d-flex">
                    <div class="comment-pic"><img src="../img/customer02.jpg" alt="">
                    ...
                    <div class="comment-content position-absolute">
                        <p>萬聖節來玩，有萬聖節限定的酒水，很好喝，節慶感十足，然後一定要特別稱讚一下這裡的店員，每個都很用心裝扮，雖然當天生意很好，但對待每個客人都不馬虎這是一個很舒服的萬聖節，推推推推!期待下一個節日的見面!!!
                        </p>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                <div class="comment col position-relative d-flex">
                    <div class="comment-pic"><img src="../img/customer03.jpg" alt="">
                    ...
                    <div class="comment-content position-absolute">
                        <p>可照酒單點，酒感過重或輕也都能幫你微調，或者提供自己對cocktail的喜好，請厲害的Bartender幫你調上一杯！相信我至今我還沒失望過！
                        </p>
                    </div>
                </div>
            ...
            <div class="row align-items-end">
                <div class="comment col position-relative d-flex">
                    <div class="comment-pic"><img src="../img/customer04.jpg" alt=""></div>
                    <div class="comment-name position-absolute">
                        <h6>陳志龍的妹妹</h6>
                    </div>
                    <div class="comment-time position-absolute">
                    ...
                    <div class="comment-content position-absolute">
                        <p>路過這間酒吧就被吸引，
                            酒酣耳熱之後服務人員很熱情的介紹樓上Attic也是個適合酒聚的場所
                            一上樓之後如入世外桃源，
                            綁馬尾和光頭的bartender們非常熱情的介紹他們的酒單，
                            每一杯都非常有層次 之後一定會再帶朋友來的。
                        </p>
                    </div>
                </div>
